/**
 ******************************************************************************
 * @addtogroup SantyPilot team
 * @brief These files are the core system files for Mist.
 * They are the ground layer just above PiOS. In practice, Mist actually starts
 * in the main() function of mist.cpp
 * @{
