...
void ut_sigmas(const double M[13], const double P[169], double c, double X[351])
{
    ...
    if (ajj > 0.0) {
      ...
      if (j < 13) {
        if (j - 1 != 0) {
          iy = jj + 13;
          i1 = (colj + 13 * (12 - j)) + 14;
          for (jmax = colj + 14; jmax <= i1; jmax += 13) {
            ix = colj;
            b_c = 0.0;
            ibtile = (jmax + j) - 2;
        ...
        ajj = 1.0 / ajj;
        i1 = (jj + 13 * (12 - j)) + 14;
        for (ibtile = jj + 13; ibtile + 1 <= i1; ibtile += 13) {
          A[ibtile] *= ajj;
        }
  ...
  for (i1 = 0; i1 < 13; i1++) {
    for (ibtile = 0; ibtile < 13; ibtile++) {
      b_A[ibtile + 13 * i1] = A[i1 + 13 * ibtile];
    }
  }
  ...
  for (i1 = 0; i1 < 13; i1++) {
    x[i1] = 0.0;
    for (ibtile = 0; ibtile < 13; ibtile++) {
      x[ibtile + 13 * (i1 + 1)] = ajj * b_A[ibtile + 13 * i1];
      x[ibtile + 13 * (i1 + 14)] = ajj * -b_A[ibtile + 13 * i1];
    }
  }

  for (i1 = 0; i1 < 27; i1++) {
    for (ibtile = 0; ibtile < 13; ibtile++) {
      X[ibtile + 13 * i1] = x[ibtile + 13 * i1] + b[ibtile + 13 * i1];
    }
  }
}
